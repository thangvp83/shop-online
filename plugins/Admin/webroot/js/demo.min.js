...
function setThemes($nameTheme){
    $.ajax({
        dataType: 'JSON',
        url: BASE_URL + 'admin/users/set_theme',
        data: {theme: $nameTheme},
    })
}
if (typeof CUR_SMART_THEME != 'underfine' && CUR_SMART_THEME) {
    $.root_.removeClassPrefix("smart-style").addClass(CUR_SMART_THEME);
    $("#smart-styles > a #skin-checked").remove(), $("#smart-styles > #"+CUR_SMART_THEME+"").prepend("<i class='fa fa-check fa-fw' id='skin-checked'></i>")
}